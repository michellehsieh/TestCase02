namespace TestCase02.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資料統計表Repository Get客戶資料統計表Repository()
		{
			var repository = new 客戶資料統計表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資料統計表Repository Get客戶資料統計表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資料統計表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
